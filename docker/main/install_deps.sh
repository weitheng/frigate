...
if [[ "${TARGETARCH}" == "amd64" ]]; then
    pip3 install --break-system-packages https://github.com/weitheng/tflite_noAVX/blob/main/tflite_runtime-2.17.0-cp311-cp311-linux_x86_64.whl
...
if [[ "${TARGETARCH}" == "arm64" ]]; then
    pip3 install --break-system-packages https://github.com/weitheng/tflite_noAVX/blob/main/tflite_runtime-2.17.1-cp311-cp311-linux_aarch64.whl
