...
X86_DGPU_LEGACY_ARGS := ARCH=amd64 COMPUTE_LEVEL="50 60 70 80 90" TRT_REQUIREMENTS=requirements-amd64-legacy.txt
...
local-trt-legacy: version
	$(X86_DGPU_LEGACY_ARGS) docker buildx bake --file=docker/tensorrt/trt.hcl tensorrt \
		--set tensorrt.tags=frigate:latest-tensorrt-legacy \
		--load
