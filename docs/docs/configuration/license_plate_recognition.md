...
Users without a model that detects license plates can still run LPR. Frigate uses a WPOD-NET license plate detection model that runs on your CPU. In this case, you should _not_ define `license_plate` in your list of objects to track.
